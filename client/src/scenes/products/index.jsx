      ...
      <Card sx={{
        ...
        <Collapse in={isExpanded} timeout="auto" unmountOnExit sx={{
          ...
          <CardContent>
            ...
            <Typography>Yearly sales {new Date().getFullYear()} : {stat?.yearlySalesTotal} </Typography>
            <Typography>Yearly unit sales {new Date().getFullYear()} : {stat?.yearlyTotalSoldUnits} </Typography>
          </CardContent>
        </Collapse>
      </Card>
    )
